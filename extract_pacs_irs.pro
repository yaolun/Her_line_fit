        ...
        if not keyword_set(global_noise) then begin
            ...
            if keyword_set(fixed_width) then begin
        		fit_line, filename, line_name[i], wll, fluxx, std=stdd, status, errmsg, cen_wl, sig_cen_wl, str, sig_str, fwhm, sig_fwhm,$
                              ...
                              /fixed_width, base_range=base_range, no_plot=no_plot, feedback=feedback, r_spectral=r_spectral
            endif else begin
        		fit_line, filename, line_name[i], wll, fluxx, std=stdd, status, errmsg, cen_wl, sig_cen_wl, str, sig_str, fwhm, sig_fwhm,$
                              base_para, snr, line, noise, plot_base=plot_base, /single_gauss, outdir=plotdir, noiselevel=noiselevel,$
    ...
    if keyword_set(global_noise) then begin
    	...
    	for i = 0, n_elements(line_name)-1 do begin
            ...
            if keyword_set(fixed_width) then begin
                fit_line, filename, line_name[i], wll, fluxx, std=stdd, status, errmsg, cen_wl, sig_cen_wl, str, sig_str, fwhm, sig_fwhm,$
                                      base_para, snr, line, noise, plot_base=plot_base, /single_gauss, outdir=plotdir, noiselevel=noiselevel,$
                                      /fixed_width, global_noise=flat_noise_smooth, base_range=base_range, no_plot=no_plot, r_spectral=r_spectral
            endif else begin
                fit_line, filename, line_name[i], wll, fluxx, std=stdd, status, errmsg, cen_wl, sig_cen_wl, str, sig_str, fwhm, sig_fwhm,$
                                      base_para, snr, line, noise, plot_base=plot_base, /single_gauss, outdir=plotdir, noiselevel=noiselevel,$
                                      global_noise=flat_noise_smooth, base_range=base_range, no_plot=no_plot, r_spectral=r_spectral
            endelse
            ...
            if keyword_set(fixed_width) then begin
                fit_line, filename, line_name[i], wll, fluxx, std=stdd, status, errmsg, cen_wl, sig_cen_wl, str, sig_str, fwhm, sig_fwhm,$
                                      base_para, snr, line, noise, plot_base=plot_base, /single_gauss, outdir=plotdir, noiselevel=noiselevel,$
                                      /fixed_width, global_noise=flat_noise_smooth, base_range=base_range, no_plot=no_plot, feedback=feedback, r_spectral=r_spectral
            endif else begin
                fit_line, filename, line_name[i], wll, fluxx, std=stdd, status, errmsg, cen_wl, sig_cen_wl, str, sig_str, fwhm, sig_fwhm,$
                                      base_para, snr, line, noise, plot_base=plot_base, /single_gauss,outdir=plotdir, noiselevel=noiselevel,$
                                      global_noise=flat_noise_smooth, base_range=base_range, no_plot=no_plot, feedback=feedback, r_spectral=r_spectral
            endelse
