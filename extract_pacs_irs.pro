pro extract_line, indir=indir, filename=filename, outdir=outdir, plotdir=plotdir, noiselevel=noiselevel, ra=ra, dec=dec,$
	...
	plot_subtraction=plot_subtraction, no_plot=no_plot, double_gauss=double_gauss
    ...
    readcol, indir+filename+'.txt', format='D,D,D', comment='#', wl, flux, unc, /silent
    ; Get rid off the NaN
	...
	line_name = ['FeII26', 'FEII35']
	line_center = [25.97, 35.3]
	cont = [[25.5, 25.92, 26.02, 26.5],[35.0, 35.2, 35.4, 36.0]]
