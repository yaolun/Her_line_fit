...
if keyword_set(baseline) then begin
    ...
    ;device, filename = '/Users/yaolun/data/spire_corrected_joel/plots/base/'+pixelname+'_'+linename+'base.eps', /helvetica, /portrait, /encapsulated, isolatin = 1, font_size = 14, decomposed = 0, /color
    ;device, filename = '/Users/yaolun/bhr71/plots/base/'+pixelname+'_'+linename+'base.eps', /helvetica, /portrait, /encapsulated, isolatin = 1, font_size = 14, decomposed = 0, /color
    loadct ,13
...
;    dl = median(wl)/r
  ...
  if keyword_set(single_gauss) then begin
    ...
    parinfo[2].limited = [1,1] & parinfo[2].limits = [dl,4.5*dl]
  endif
  if keyword_set(double_gauss) then begin
    ...
    parinfo[2].limited = [0,1] & parinfo[2].limits = [dl,4.5*dl]
    parinfo[4].limited = [0,1] & parinfo[4].limits = [dl,4.5*dl]
  endif
  ;-------------------------------------------
  ;Fit it!
  ...
  p = result
   ...
   print, 'double'
      ...
      if keyword_set(test) then begin
	      if snr le 3 then msg='_below3sigma'
      endif
      ;Make a plot
      ;plot the well-functional fitting result
      set_plot, 'ps'
      !p.font = 0
      device, filename = '/Users/yaolun/bhr71/plots/'+pixelname+'_'+linename+msg+'.eps', /helvetica, /portrait, /encapsulated, isolatin = 1, font_size = 14, decomposed = 0, /color
      ;device, filename = '/Users/yaolun/Rebecca/plots/'+pixelname+'_'+linename+msg+'.eps', /helvetica, /portrait, /encapsulated, isolatin = 1, font_size = 14, decomposed = 0, /color
      ;device, filename = '/Users/yaolun/data/spire_corrected_joel/plots/'+pixelname+'_'+linename+msg+'.eps', /helvetica, /portrait, /encapsulated, isolatin = 1, font_size = 14, decomposed = 0, /color
      loadct ,13
      !p.thick = 3 & !x.thick = 3 & !y.thick = 3
      ...
      oplot, fine_wl, (gauss_fine)/1d-22, color = 80                                                                                                    ;plot the fitted curve(Gaussian)
      ...
      ;device, filename = '/Users/yaolun/data/spire_corrected_joel/plots/cannot_fit/'+pixelname+'_'+linename+'cannot_fit'+msg+'.eps', /helvetica, /portrait, /encapsulated, isolatin = 1, font_size = 14, decomposed = 0, /color
      loadct ,13
      !p.thick = 3 & !x.thick = 3 & !y.thick = 3
