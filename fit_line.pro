...
if keyword_set(baseline) then begin
    ...
    if not keyword_set(no_plot) then begin
        ...
        plot, plot_base[*,0], plot_base[*,1]/1d-22, psym = 10, yrange=[1.2*min(residual)/1d-22, 1.1*max(flux)/1d-22], xtitle = '!3Wavelength(!9m!3m)', ytitle = '!3Flux Density(10!u-22!n W/cm!u2!n/!9m!3m)',position=[0.2,0.15,0.95,0.95]                   ;plot the original data
